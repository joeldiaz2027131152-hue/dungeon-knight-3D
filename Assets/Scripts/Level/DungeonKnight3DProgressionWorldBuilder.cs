...
namespace DungeonKnight.Level
{
    internal sealed class DungeonKnight3DProgressionWorldBuilder
    {
        ...
        public void BuildWorldOneThree(PlayerController3D player)
        {
            ...
            traversal.CreateStairRun("World 1-3 Lower Tower Stair", new Vector3(-5.5f, 0f, 80.8f), 18, new Vector3(0f, 0.17f, 0.37f), 1.55f);
            traversal.CreateStairRun("World 1-3 Upper Tower Stair", new Vector3(5.2f, 3.1f, 89.1f), 18, new Vector3(0f, 0.17f, 0.37f), 1.55f);
