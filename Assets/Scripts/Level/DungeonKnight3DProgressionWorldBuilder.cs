...
namespace DungeonKnight.Level
{
    internal sealed class DungeonKnight3DProgressionWorldBuilder
    {
        ...
        public void BuildWorldOneThree(PlayerController3D player)
        {
            ...
            traversal.CreateStairRun("World 1-3 Lower Tower Stair", new Vector3(-5.5f, 0f, 80.8f), 13, new Vector3(0.45f, 0.25f, 0.48f), 1.35f);
            traversal.CreateStairRun("World 1-3 Upper Tower Stair", new Vector3(5.2f, 3.1f, 89.1f), 13, new Vector3(-0.45f, 0.25f, 0.48f), 1.35f);
