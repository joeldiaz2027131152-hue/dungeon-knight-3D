...
namespace DungeonKnight.Player
{
    ...
    public class PlayerController2D : MonoBehaviour
    {
        ...
        [SerializeField] private float blockMoveMultiplier = 0.3f;
        ...
        public bool IsCrouching => isGrounded && !isRolling && !IsBlocking && (Input.GetKey(KeyCode.S) || Input.GetKey(KeyCode.DownArrow));
