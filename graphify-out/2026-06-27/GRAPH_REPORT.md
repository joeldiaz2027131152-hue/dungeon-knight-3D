...
## Corpus Check
- 141 files · ~6,549,200 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2136 nodes · 4119 edges · 135 communities (133 shown, 2 thin omitted)
...
3. `Vector3` - 67 edges
4. `RiggedSkeletonEnemyVisual3D` - 60 edges
5. `Vector2` - 59 edges
...
## Knowledge Gaps
- **639 isolated node(s):** `DungeonKnight.Editor`, `MenuItem`, `DungeonKnight.Editor`, `Predicate<Transform>`, `DungeonKnight.Editor` (+634 more)
