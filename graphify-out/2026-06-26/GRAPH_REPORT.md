# Graph Report - dungeon-knight-3D  (2026-06-26)

## Corpus Check
- 140 files · ~6,447,504 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2103 nodes · 4045 edges · 134 communities (132 shown, 2 thin omitted)
...
1. `DungeonKnight3DBootstrap` - 136 edges
2. `WorldOneOneBootstrap` - 82 edges
3. `Vector3` - 66 edges
4. `Vector2` - 59 edges
5. `RiggedSkeletonEnemyVisual3D` - 58 edges
6. `PlayerModelVisual3D` - 48 edges
7. `GameHud3D` - 48 edges
8. `DungeonKnight3DEditorMenu` - 47 edges
9. `CharacterSpriteFactory` - 45 edges
10. `PlayerController2D` - 43 edges
...
## Communities (134 total, 2 thin omitted)
...
Cohesion: 0.10
Nodes (16): bool, CharacterController, Color, float, int, Material, Object, PlayerController3D (+8 more)
...
## Knowledge Gaps
- **635 isolated node(s):** `DungeonKnight.Editor`, `MenuItem`, `DungeonKnight.Editor`, `Predicate<Transform>`, `DungeonKnight.Editor` (+630 more)
...
- **Should `3D Scene Bootstrap` be split into smaller, more focused modules?**
  _Cohesion score 0.05763927192498621 - nodes in this community are weakly interconnected._
