# Graph Report - dungeon-knight-3D  (2026-06-21)

## Corpus Check
- 138 files · ~6,389,479 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1949 nodes · 3547 edges · 132 communities (130 shown, 2 thin omitted)
...
1. `DungeonKnight3DBootstrap` - 97 edges
2. `WorldOneOneBootstrap` - 82 edges
3. `Vector2` - 59 edges
4. `PlayerModelVisual3D` - 48 edges
5. `GameHud3D` - 48 edges
6. `RiggedSkeletonEnemyVisual3D` - 47 edges
7. `CharacterSpriteFactory` - 45 edges
8. `PlayerController2D` - 43 edges
9. `PlayerController3D` - 42 edges
10. `Sprite` - 35 edges
...
Cohesion: 0.07
Nodes (19): bool, Bounds, Color, DungeonInteractable3D, GameObject, Light, Material, Object (+11 more)
...
Cohesion: 0.08
Nodes (26): bool, Color, EquipmentItem, GUIStyle, HudMessageIcon, int, Material, PlayerController3D (+18 more)
...
Cohesion: 0.31
Nodes (6): Color, Material, Transform, Vector3, DungeonKnight.Level, RiggedSkeletonSwordVisual3D
...
Cohesion: 0.15
Nodes (6): Bounds, MenuItem, Transform, Vector3, DungeonKnight3DEditorMenu, DungeonKnight.Editor
...
## Knowledge Gaps
- **623 isolated node(s):** `DungeonKnight.Editor`, `MenuItem`, `DungeonKnight.Editor`, `Bounds`, `DungeonKnight.Combat` (+618 more)
...
- **Should `3D Scene Bootstrap` be split into smaller, more focused modules?**
  _Cohesion score 0.0691471287801563 - nodes in this community are weakly interconnected._
