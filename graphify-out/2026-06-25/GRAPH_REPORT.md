# Graph Report - dungeon-knight-3D  (2026-06-25)

## Corpus Check
- 139 files · ~6,394,413 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2017 nodes · 3809 edges · 133 communities (131 shown, 2 thin omitted)
...
1. `DungeonKnight3DBootstrap` - 133 edges
2. `WorldOneOneBootstrap` - 82 edges
3. `Vector3` - 64 edges
4. `Vector2` - 59 edges
5. `RiggedSkeletonEnemyVisual3D` - 48 edges
6. `PlayerModelVisual3D` - 48 edges
7. `GameHud3D` - 48 edges
8. `CharacterSpriteFactory` - 45 edges
9. `PlayerController2D` - 43 edges
10. `PlayerController3D` - 43 edges
...
Cohesion: 0.09
Nodes (19): AnimationClip, AnimationClipPlayable, AnimationMixerPlayable, Animator, bool, Bounds, Color, float (+11 more)
...
## Knowledge Gaps
- **631 isolated node(s):** `DungeonKnight.Editor`, `MenuItem`, `DungeonKnight.Editor`, `Bounds`, `DungeonKnight.Combat` (+626 more)
...
- **Why does `PlayerController3D` connect `3D Player Controller` to `3D Billboard & Key Drop`?**
